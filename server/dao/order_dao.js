...
exports.orderDao={
    ...
    //==========================================插入订单
    insertOrder:function (user_id,book_id,order_num,order_bianhao,receive_name,receive_address,receive_phone,callback) {
        pool.getConnection(function (error,client) {
            if(error){
                return
            }
            client.query(orderSql.insertOrder,[user_id,book_id,order_num,order_bianhao,receive_name,receive_address,receive_phone],function (error,result) {
                if(error){
